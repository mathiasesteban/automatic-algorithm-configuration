...
def train_lipizzaner(batch_size, network, smote_size, mutation_probabilitie, adam_rate):
    ...
    output_path = str(DIR) + "/generated/" + timestamp
    os.mkdir(output_path)

    # Create general configuration file
    general_config_template = open(str(DIR) + "/templates/general_config_template.yml", "rt")
    ...
    config_template = open(str(DIR) + "/templates/config_template.yml", "rt")
