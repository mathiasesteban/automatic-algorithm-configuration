...
def prepare_seq(workdir, experiment_path, config):
                ...
                for mutation_probability in lipizzaner_config['mutations_probabilities']:
                    for adam_rate in lipizzaner_config['adam_rates']:
                        ...
                        for i in range(1, config["n_executions"]+1):
                            ...
                            general_config_template = open(workdir + "/templates/general_config_template.yml", "rt")
                            ...
                            config_template = open(str(workdir) + "/templates/specific_config_template.yml", "rt")
                            specific_config_path = instance_dir + "/config.yml"
